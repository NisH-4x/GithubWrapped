        ...
        <div className="relative min-h-screen w-full">
            ...
            <div className='w-full text-white h-full flex items-center flex-col z-[10000] bg-transparent px-4 overflow-hidden'>
                ...
                <footer className='mt-20 pb-10 z-[99999] text-center'>
                    <h1 className='text-white text-sm  text-center'>build🤍 by <a href="https://nishx.vercel.app/" target='_blank' className='underline cursor-pointer'>Nishant Chauhan</a> </h1>
                    <a href='https://nishx.vercel.app/' className='mt-2 underline text-sm text-center'>Request a feature ⚡ or report a bug 🪲 </a>
                </footer>
            </div>
